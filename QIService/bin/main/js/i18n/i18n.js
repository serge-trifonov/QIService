...
export const i18n = new VueI18n({
	...
	messages : {
		en : {		
			...
			university:'UNIVERSITY',
			see:'SEE',
			createProfile:'To take full advantage of the application, you should create your student\'s profile',
			add:'ADD',
			faculty:'FACULTY',
			program:'PROGRAM',
		...
		fr : {
			...
			university:'UNIVERSITÉ',
			see:'VOIR',
			createProfile:'Il faut remplir votre profile pour pouvoir profiter pleinement de toutes les fonctionnalités de l\'application',
			add:'AJOUTER',
			faculty:'FACULTÉ',
			program:'PROGRAMME',
